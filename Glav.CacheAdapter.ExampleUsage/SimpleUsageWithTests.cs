    ...
    class SimpleUsageWithTests
    {
        public static bool ExampleAddAndRetrieveFromCache()
        {
           // int _accessCounter = 0;
            ...
            Console.WriteLine("#1: Add Some Data.");
            var someData = new SomeData() { SomeText = "cache example1", SomeNumber = 1 };

            cacheProvider.Add("cache-key", DateTime.Now.AddMinutes(5), someData);
            ...
            var data1 = cacheProvider.Get<SomeData>("cache-key", DateTime.Now.AddSeconds(5), () =>
            {
                ...
                var someData2 = new SomeData() { SomeText = "cache example2", SomeNumber = 2 };
                return someData;
            });
            ...
            //    var someData3 = new SomeData() { SomeText = "cache example3", SomeNumber = 3 };
            //    return someData;
            //});
